...
public class FilterTwo implements Filter<List<Issuer>> {
    ...
    public FilterTwo(IssuerRepository issuerRepository, IssuerDataRepository issuerDataRepository) {
    ...
    public List<Issuer> execute(List<Issuer> input) throws IOException, ParseException {
        List<Issuer> companies = new ArrayList<>();
    ...
    private void addData(Issuer company, LocalDate fromDate, LocalDate toDate) throws IOException {
