...
public class IssuerData {
    ...
    @ManyToOne
    private Issuer company;

    public IssuerData(LocalDate date, Double lastTransactionPrice, Double maxPrice, Double minPrice, Double averagePrice, Double percentageChange, Integer quantity, Integer turnoverBest, Integer totalTurnover) {
        this.date = date;
