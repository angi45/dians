...
public class FilterReAddCompanyDetails implements Filter<List<ProfileEntity>> {
    ...
    public List<ProfileEntity> execute(List<ProfileEntity> input) throws IOException, ParseException {
