...
public class TradeHistoryEntity {
    ...
    private ProfileEntity company;

    public TradeHistoryEntity(LocalDate date, Double lastTransactionPrice, Double maxPrice, Double minPrice, Double averagePrice, Double percentageChange, Integer quantity, Integer turnoverBest, Integer totalTurnover) {
        this.date = date;
